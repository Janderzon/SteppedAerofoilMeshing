...
cNoseNearWallHeight = firstCellHeight*1
...
ffTopPoint = gmsh.model.geo.addPoint(1, 20, 0, 6)
ffLeftPoint = gmsh.model.geo.addPoint(1-20, 0, 0, 6)
ffBottomPoint = gmsh.model.geo.addPoint(1, -20, 0, 6)
ffRightPoint = gmsh.model.geo.addPoint(1+20, 0, 0, 6)
...
#Create the surface
farFieldSurface = gmsh.model.geo.addPlaneSurface([farFieldLoop, olLoop])

################################################################################
#   Far Field Geometry 2
################################################################################

#Create points for the far field
ffTopPoint2 = gmsh.model.geo.addPoint(1, ffBoundaryScaling, 0)
ffLeftPoint2 = gmsh.model.geo.addPoint(1-ffBoundaryScaling, 0, 0)
ffBottomPoint2 = gmsh.model.geo.addPoint(1, -ffBoundaryScaling, 0)
ffRightPoint2 = gmsh.model.geo.addPoint(1+ffBoundaryScaling, 0, 0)

#Create lines for the far field
ffTopLeftArc2 = gmsh.model.geo.addCircleArc(ffTopPoint2, trailingEdge, ffLeftPoint2)
ffBottomLeftArc2 = gmsh.model.geo.addCircleArc(ffLeftPoint2, trailingEdge, ffBottomPoint2)
ffTopRightArc2 = gmsh.model.geo.addCircleArc(ffBottomPoint2, trailingEdge, ffRightPoint2)
ffBottomRightArc2 = gmsh.model.geo.addCircleArc(ffRightPoint2, trailingEdge, ffTopPoint2)

#Create the curve loop for the far field
farFieldLoop2 = gmsh.model.geo.addCurveLoop([ffTopLeftArc2, ffBottomLeftArc2, ffBottomRightArc2, ffTopRightArc2])

#Create the surface
farFieldSurface2 = gmsh.model.geo.addPlaneSurface([farFieldLoop2, farFieldLoop])
...
farFieldGroup = gmsh.model.addPhysicalGroup(1, [ffTopLeftArc2, ffBottomLeftArc2, ffBottomRightArc2, ffTopRightArc2])
gmsh.model.setPhysicalName(1, farFieldGroup, "farfieldboundary")
fluidGroup = gmsh.model.addPhysicalGroup(2, [cSurface, cFarSurface, olSurface, farFieldSurface, farFieldSurface2])
