...
olTopLeftPoint = gmsh.model.geo.addPoint(0, outerLayerHeight, 0, 0.036*outerLayerCellSizeScaling)
olLeftPoint = gmsh.model.geo.addPoint(-outerLayerHeight, 0, 0, 0.036*outerLayerCellSizeScaling)
olBottomLeftPoint = gmsh.model.geo.addPoint(0, -outerLayerHeight, 0, 0.036*outerLayerCellSizeScaling)
olTopRightPoint = gmsh.model.geo.addPoint(outerLayerLength, outerLayerHeight, 0, 0.036*outerLayerCellSizeScaling)
olBottomRightPoint = gmsh.model.geo.addPoint(outerLayerLength, -outerLayerHeight, 0, 0.036*outerLayerCellSizeScaling)
